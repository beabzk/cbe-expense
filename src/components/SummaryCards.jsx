...
const SummaryCards = ({ transactions = [] }) => {
    ...
    console.log("SummaryCards.jsx - transactions prop:", transactions); // Log the transactions prop
  ...
  return (
    <div className="flex flex-col md:flex-row gap-4 my-4">
      <div className="bg-green-100 border border-green-300 rounded-lg shadow p-4 flex-1">
        ...
        <p className="text-2xl font-bold">ETB {totalIncome.toFixed(2)}</p>
      </div>
      ...
      <div className="bg-blue-100 border border-blue-300 rounded-lg shadow p-4 flex-1">
        ...
        <p className="text-2xl font-bold">ETB {currentBalance.toFixed(2)}</p>
      </div>
    </div>
  );
};
